...
export class FlightDataComponent implements OnInit {
  ...
  url1 = 'http://nycflights-api-test.northeurope.azurecontainer.io/api/Flights/numberOfFlightsPerMonth';  
  url2 = 'http://nycflights-api-test.northeurope.azurecontainer.io/api/Planes';
  Model = [];
  Seats = []
  Month = [];  
  Flight = [];  
